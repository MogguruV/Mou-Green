...
public class FiturLaporanFlowTest {
    ...
    public void fullLoginLogoutFlowTest() throws InterruptedException {
        ...
        onView(withId(R.id.tombolLaporan)).perform(click());

        // Tunggu ProfilUser terbuka
        Thread.sleep(5000);

        onView(withId(R.id.inputTextKomentarLaporan)).perform(typeText("Testing Fitur Laporan Test123123"), closeSoftKeyboard());

        // Step 3: Logout
        onView(withId(R.id.tombolKirimLaporan)).perform(click());
    }
}
